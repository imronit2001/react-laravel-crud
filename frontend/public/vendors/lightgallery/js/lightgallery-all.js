        ...
        Plugin.prototype.structure = function () {
            ...
            if (this.s.controls && this.$items.length > 1) {
                controls = '<div className="lg-actions">' +
                    '<button type="button" aria-label="Previous slide" className="lg-prev lg-icon">' + this.s.prevHtml + '</button>' +
                    '<button type="button" aria-label="Next slide" className="lg-next lg-icon">' + this.s.nextHtml + '</button>' +
                    '</div>';
            }

            if (this.s.appendSubHtmlTo === '.lg-sub-html') {
                subHtmlCont = '<div role="status" aria-live="polite" className="lg-sub-html"></div>';
            }
            ...
            template = '<div tabindex="-1" aria-modal="true" ' + ariaLabelledby + ' ' + ariaDescribedby + ' role="dialog" className="lg-outer ' + this.s.addClass + ' ' + this.s.startClass + '">' +
                ...
                '<button type="button" aria-label="Close gallery" className="lg-close lg-icon"></button>' +
                '</div>' +
                controls +
                subHtmlCont +
                '</div>' +
            ...
            if (this.s.download) {
                this.$outer.find('.lg-toolbar').append('<a id="lg-download" aria-label="Download" target="_blank" download className="lg-download lg-icon"></a>');
            }
        ...
        Plugin.prototype.loadContent = function (index, rec, delay) {
            ...
            if (!_this.$slide.eq(index).hasClass('lg-loaded')) {
                if (iframe) {
                    ...
                    _alt = _alt ? 'alt="' + _alt + '"' : '';
                    _this.$slide.eq(index).prepend('<div className="lg-img-wrap"><img className="lg-object lg-image" ' + _alt + ' src="' + _src + '" /></div>');
                }
...
(function (root, factory) {
    ...
    (function () {
        ...
        Autoplay.prototype.controls = function () {
            var _this = this;
            var _html = '<button type="button" aria-label="Toggle autoplay" className="lg-autoplay-button lg-icon"></button>';
        ...
        Fullscreen.prototype.init = function () {
            ...
            if (this.core.s.fullScreen) {
                ...
                if (!document.fullscreenEnabled && !document.webkitFullscreenEnabled &&
                    ...
                    fullScreen = '<button type="button" aria-label="Toggle fullscreen" className="lg-fullscreen lg-icon"></button>';
    ...
    (function () {
        ...
        Thumbnail.prototype.toogle = function () {
            ...
            if (_this.core.s.toogleThumb) {
                ...
                _this.$thumbOuter.append('<button type="button" aria-label="Toggle thumbnails" className="lg-toogle-thumb lg-icon"></button>');
    ...
    (function () {
        ...
        Video.prototype.loadVideo = function (src, addClass, noPoster, index, html) {
            ...
            if (isVideo.youtube) {
                ...
                video = '<iframe allow="autoplay" className="lg-video-object lg-youtube ' + addClass + '" ' + videoTitle + ' width="560" height="315" src="//www.youtube.com/embed/' + isVideo.youtube[1] + a + '" frameborder="0" allowfullscreen></iframe>';
                ...
                video = '<iframe allow="autoplay" className="lg-video-object lg-vimeo ' + addClass + '" ' + videoTitle + ' width="560" height="315"  src="//player.vimeo.com/video/' + isVideo.vimeo[1] + a + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>';
                ...
                video = '<iframe allow="autoplay" className="lg-video-object lg-dailymotion ' + addClass + '" ' + videoTitle + ' width="560" height="315" src="//www.dailymotion.com/embed/video/' + isVideo.dailymotion[1] + a + '" frameborder="0" allowfullscreen></iframe>';
                ...
                video = '<iframe allow="autoplay" className="lg-video-object lg-vk ' + addClass + '" ' + videoTitle + ' width="560" height="315" src="//vk.com/video_ext.php?' + isVideo.vk[1] + a + '" frameborder="0" allowfullscreen></iframe>';
...
(function (root, factory) {
    ...
    (function () {
        ...
        Zoom.prototype.init = function () {
            ...
            var _this = this;
            var zoomIcons = '<button type="button" aria-label="Zoom in" id="lg-zoom-in" className="lg-icon"></button><button type="button" aria-label="Zoom out" id="lg-zoom-out" className="lg-icon"></button>';

            if (_this.core.s.actualSize) {
                zoomIcons += '<button type="button" aria-label="Actual size" id="lg-actual-size" className="lg-icon"></button>';
            }
...
(function (root, factory) {
    ...
    (function () {
        ...
        Share.prototype.init = function () {
            ...
            var shareHtml = '<button type="button" aria-label="Share" id="lg-share" className="lg-icon" aria-haspopup="true" aria-expanded="false">' +
    ...
    (function () {
        ...
        Rotate.prototype.buildTemplates = function () {
            ...
            if (this.core.s.flipVertical) {
                rotateIcons += '<button aria-label="Flip vertical" className="lg-flip-ver lg-icon"></button>';
            }
            if (this.core.s.flipHorizontal) {
                rotateIcons += '<button aria-label="flip horizontal" className="lg-flip-hor lg-icon"></button>';
            }
            if (this.core.s.rotateLeft) {
                rotateIcons += '<button aria-label="Rotate left" className="lg-rotate-left lg-icon"></button>';
            }
            if (this.core.s.rotateRight) {
                rotateIcons += '<button aria-label="Rotate right" className="lg-rotate-right lg-icon"></button>';
            }
        ...
        Rotate.prototype.init = function () {
            ...
            this.core.$el.on('onAferAppendSlide.lg.tm.rotate', function (event, index) {
                ...
                $imageWrap.wrap('<div className="lg-img-rotate"></div>');
            });
